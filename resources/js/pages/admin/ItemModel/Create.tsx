...
export default function Create({ editData, readOnly }: { editData?: any; readOnly?: boolean }) {
    ...
    const { brands } = usePage<any>().props;
    ...
    const onSubmit = (e: React.FormEvent) => {
        ...
        if (editData?.id) {
            post(`/admin/item-models/${editData.id}/update`, {
                onSuccess: (page: any) => {
                    setFiles(null);
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: 'Models', href: '/admin/item-models' },
                        ...
                        <div className="form-field-container">
                            {brands?.length > 0 && (
                                <FormCombobox
                                    ...
                                    description="Select the brand that this model belongs to."
                                />
                            )}
                            {/* <FormField
                                required
                        ...
                        <div className={cn('form-field-container', !editData?.image && 'md:grid-cols-1')}>
                            ...
                            {editData?.image && (
                                <UploadedImage
                                    ...
                                    basePath="/assets/images/item_models/thumb/"
                                />
                            )}
                        </div>
                    </>
