...
export default function Create({
    ...
    const { all_users, all_brands, provinces } = usePage<any>().props;
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem className="flex flex-col" key={field.value}>
                                                    ...
                                                    <CommandList>
                                                        ...
                                                        <CommandGroup>
                                                            ...
                                                            {provinces?.map((item: any) => {
                                                                return (
                                                                    <CommandItem
                                                                        value={item.name_kh + item.name + item.code}
                                                                        key={item.code}
                                                                        onSelect={() => {
                                                                            form.setValue('province_code', item.code.toString());
                                                                        }}
                                                                    >
                                                                        <Check
                                                                            className={cn(
                                        ...
                                        <FormMessage>{errors.province_code && <div>{errors.province_code}</div>}</FormMessage>
                                    </FormItem>
                                )}
                            />
                        </div>
