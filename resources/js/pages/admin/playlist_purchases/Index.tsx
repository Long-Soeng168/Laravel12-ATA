...
const Index = () => {
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: t('Playlist Purchases'), href: '#' },
    ];
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            <div className="flex flex-wrap items-center justify-between gap-2 px-2 py-6">
                <div className="flex w-full gap-2 md:w-auto">
                    <TableDataSearch placeholder={t('Search purchases...')} />
                    <RefreshButton />
                </div>

                <div className="flex w-full justify-end md:w-auto">
                    <NewItemButton url="/admin/playlist_purchases/create" permission="video create" />
                </div>
            </div>
