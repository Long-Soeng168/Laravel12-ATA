                                ...
                                <TableCellActions>
                                    {item.deleted_at ? (
                                        ...
                                        <div className="space-x-2">
                                            {/* Edit Dialog */}
                                            <EditItemButton url={`/admin/item-categories/${item.id}/edit`} permission="item update" />

                                            {/* View Dialog */}
                                            <ViewItemButton url={`/admin/item-categories/${item.id}`} permission="item view" />

                                            {/* Delete Item */}
                                            <DeleteItemButton deletePath="/admin/item-categories/" id={item.id} permission="item delete" />
                                        </div>
                                    )}
                                </TableCellActions>
                                <TableCell>
