...
import { FormDescription } from '@/components/Input/FormDescription';
...
export default function CreateForm() {
    ...
    const { data, setData, post, processing, progress, errors, reset, transform } = useForm({
        is_user_create_or_edit_shop: is_user_create_or_edit_shop || false,
        ...
        <>
            <form onSubmit={onSubmit} className="space-y-8 p-4">
                            ...
                            {editData?.owner_user_id && editData?.owner_user_id != data.owner_user_id && (
                                <div className="mt-2 flex items-start gap-3 rounded border border-yellow-200 bg-yellow-50 p-3 text-sm text-yellow-800 dark:border-yellow-900/50 dark:bg-yellow-900/20 dark:text-yellow-500">
                                    ...
                                    <div className="flex flex-col gap-1">
                                        ...
                                        <span>
                                            {t(
                                                'Warning: You are about to change the shop owner. This action may restrict the previous owner’s access.',
                                            )}
                                        </span>
                                    </div>
                                </div>
                ...
                <div className="space-y-2 md:col-span-2">
                    ...
                    />
                    <FormDescription description="Select product categories that you sell." />
                ...
                <div className="form-field-container">
                    {provinces?.length > 0 && (
                        <FormCombobox
                            ...
                            description="Select provine where you sell."
                        />
                    )}
                    {all_users?.length > 0 && (
                        <FormField
